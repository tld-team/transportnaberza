		...
		<div class="container pos-rel">
			<div class="row">
				<div class="col-md-12 col-lg-6">
					<p><img src="assets/images/years_img.png" alt=""></p>
					...
					<div class="row">
						...
						<div class="col-12 col-md-6">
							<div class="icon-box-6">
								...
								<h3 class="h3-sm txt-blue">Packaging and Storage</h3>
						...
						<div class="col-12 col-md-6">
							<div class="icon-box-6">
								...
								<h3 class="h3-sm txt-blue">Safety & Quality</h3>
								<p>Praesent pellentesque diam vitae nibh aliquam faucibus.</p>
								<a href="#" class="btn-arrow bg-navy-blue"><i class="icofont-swoosh-right"></i></a>
							</div>
						</div>
						...
						<div class="col-12 col-md-6">
							<div class="icon-box-6">
								...
								<h3 class="h3-sm txt-blue">Care for Environment</h3>
								<p>Praesent pellentesque diam vitae nibh aliquam faucibus.</p>
								<a href="#" class="btn-arrow bg-navy-blue"><i class="icofont-swoosh-right"></i></a>
							</div>
						</div>
						...
						<div class="col-12 col-md-6">
							<div class="icon-box-6">
								...
								<h3 class="h3-sm txt-blue">Delivery On Time</h3>
								<p>Praesent pellentesque diam vitae nibh aliquam faucibus.</p>
								<a href="#" class="btn-arrow bg-navy-blue"><i class="icofont-swoosh-right"></i></a>
							</div>
						</div>
	...
	<section class="bg-light-gray wide-tb-100 bg-wave">
		<div class="container pos-rel">
			<div class="row">
				...
				<div class="col-lg-7 ms-auto why-choose wow fadeInRight" data-wow-duration="0"
				     data-wow-delay="0.6s">
					<!-- Heading Main -->
		...
		<div class="container">
			<div class="row text-md-start text-center">
				...
				<div class="col-sm-12 col-md-6 text-md-end text-center">
					Designed by <a href="#" rel="nofollow">MannatStudio</a> © <span id="yearText"></span> All Rights Reserved
				</div>
			</div>
		</div>
	</div>
...
<div class="b-settings-panel active">
	...
	<a class="btn-theme bg-navy-blue btn-block reset mt-4" data-src="assets/css/style.css"
